...
export function LoadingGrid({ prompt, type, sourceImage, relay }: LoadingGridProps) {
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-sm text-muted-foreground flex-wrap">
              ...
              >
                ...
                <span className="text-xs text-primary">Routing task...</span>
              </motion.div>
            </div>
            ...
            {relay && (
              <div className="grid gap-2 rounded-lg border border-white/10 bg-white/[0.04] p-3 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span>{relay.priority}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Reserved</span>
                  <span>{relay.credits} credits</span>
                </div>
              </div>
            )}

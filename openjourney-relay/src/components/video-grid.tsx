      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {generation.videos.map((videoUrl, index) => (
            ...
            >
              <Card className="overflow-hidden aspect-video border-border/50 relative bg-[radial-gradient(circle_at_20%_20%,rgba(45,212,191,0.38),transparent_32%),radial-gradient(circle_at_82%_18%,rgba(251,146,60,0.28),transparent_34%),linear-gradient(135deg,#15211f,#0a0f0e)]">
                {generation.isLoading ? (
                  ...
                  >
                    ...
                    <video 
                      ...
                      poster={generation.sourceImage || `/sample-images/generated-image-${(index % 4) + 1}.png`}
                      preload="metadata"
                      muted
                      loop
                    >
      ...
      <div className="w-full lg:w-80 flex-shrink-0">
        <div className="lg:sticky lg:top-24">
          <div className="space-y-3">
            ...
            {/* Format badge */}
            <div>
              <Badge variant="outline" className="border-teal-300/25 bg-teal-300/10 text-xs text-teal-100">
                {generation.relay?.taskMode || "Video"}
              </Badge>
            </div>
